  ...
  public currentStat(): void {
    ...
    if (this.userCurrentStat !== null) {
      ...
      this._userStatService
        .editState(this.user._id, newState)
        .subscribe((newStat) => {
        ...
        case 'attack':
          if ((this.pokemonLeft.type === 'fire' && this.pokemonRight.type === 'grass') ||(this.pokemonLeft.type === 'grass' && this.pokemonRight.type === 'water') ||
            ...
            if (this.pokemonLeft.life <= 20) {
              ...
              life = Math.round(this.pokemonLeft.life * (this._battleService.getRandomId(80) / 100));
  ...
  public attack(): void {
    ...
    if (
      ...
      if (this.pokemonRight.life <= 20) {
        ...
        attack = Math.round(
          this.pokemonRight.life * (this._battleService.getRandomId(80) / 100)
        );
